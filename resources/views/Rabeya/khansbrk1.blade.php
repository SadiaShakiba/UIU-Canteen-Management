          ...
          <section>
            ...
            <div class="containerpage">
                ...
                <div class="row">
                    ...
                    @if ($products->canteen_name == 'Khan\'s' && $products->category == 'Breakfast')
                    <div class="col-md-6 col-lg-3 ftco-animate">
                        <div class="product">


                            <a href="{{ route('product_details' , $products->product_id) }}" class="img-prod"  data-toggle="modal" data-target=".bd-example-modal-sm"><img class="img-fluid" src="images/{{$products->product_image}}" width="350px" height="150px" alt="">
                            ...
                            <div class="text py-3 pb-4 px-3 text-center">
                                ...
                                <div class="bottom-area d-flex px-3">
                                    <div class="m-auto d-flex">
                                        ...
                                        <a href="{{ route('add_to_cart', $products->product_id)}}" class="buy-now d-flex justify-content-center align-items-center mx-1" data-toggle="modal" data-target=".bd-example-modal-sm">
                                            <span><i class="ion-ios-cart"></i></span>
                                        </a>
                                        <a href="{{ route('add_to_wishlist', $products->product_id)}}" class="heart d-flex justify-content-center align-items-center " data-toggle="modal" data-target=".bd-example-modal-sm">
