          ...
          <div class="row justify-content-center">
              ...
              <div class="col-md-10 mb-5 text-center">
                  <ul class="product-category">
                      ...
                      <li><a href="/khanssnacks1" class="active">SNACKS</a></li>
                  </ul>
              </div>
          </div>
          ...
          <section>
            ...
            <div class="containerpage">
                ...
                <div class="row">
                    ...
                    @if ($products->canteen_name == 'Khan\'s' && $products->category == 'Snacks')
                    <div class="col-md-6 col-lg-3 ftco-animate">
                        <div class="product">


                            <a href="{{ route('product_details' , $products->product_id) }}" data-toggle="modal" data-target=".bd-example-modal-sm" class="img-prod"  data-toggle="modal" data-target=".bd-example-modal-sm"><img class="img-fluid" src="images/{{$products->product_image}}" width="350px" height="150px" alt="">
