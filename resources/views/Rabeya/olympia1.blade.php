        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-10 mb-5 text-center">
                <ul class="product-category">
                    <li><a href="olympia1" class="active">All</a></li>
                      <li><a href="/olympiabrk1">BREAKFAST</a></li>
                      <li><a href="/olympialunch1">LUNCH</a></li>
        ...
        <section>
          ...
          <div class="containerpage">
           ...
           <div class="row">
              ...
              @if ($products->canteen_name == 'Olympia')
              <div class="col-md-6 col-lg-3 ftco-animate">
                  <div class="product">


                      <a href="#" class="img-prod"  data-toggle="modal" data-target=".bd-example-modal-sm"><img class="img-fluid" src="images/{{$products->product_image}}" width="350px" height="150px" alt="">
