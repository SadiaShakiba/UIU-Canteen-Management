        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-10 mb-5 text-center">
                <ul class="product-category">
                    ...
                    <li><a href="/tablet">BREAKFAST</a></li>
                    <li><a href="/firstaid">LUNCH</a></li>
                    <li><a href="/syrup">DRINKS</a></li>
                    <li><a href="/other">SNACKS</a></li>
                </ul>
            </div>
        </div>
        ...
        <section>
          ...
          <div class="containerpage">
           ...
           <div class="row">
              ...
              <?php if($products->canteen_name == 'Olympia'): ?>
              <div class="col-md-6 col-lg-3 ftco-animate">
                  <div class="product">


                      <a href="#" class="img-prod"><img class="img-fluid" src="images/<?php echo e($products->product_image); ?>" width="350px" height="150px" alt="">
                      ...
                      <div class="text py-3 pb-4 px-3 text-center">
                          ...
                          <div class="bottom-area d-flex px-3">
                              <div class="m-auto d-flex">
                                  ...
                                  <a href=""   data-toggle="modal" data-target=".bd-example-modal-sm" class="buy-now d-flex justify-content-center align-items-center mx-1">
                                      <span><i class="ion-ios-cart"></i></span>
                                  </a>
                                  <a href="#"   data-toggle="modal" data-target=".bd-example-modal-sm" class="heart d-flex justify-content-center align-items-center ">
...
<?php echo $__env->make('Rabeya.layouts.main1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\UIUCanteen\resources\views/Rabeya/olympia1.blade.php ENDPATH**/ ?>