            ...
            <div class="cart-list"  style="overflow: scroll; height:400px; width: 500px; float:left ">
                <table class="table ftco-animate" >
                    ...
                    <tbody   >
                      ...
                      <tr class="text-center">
                                   THIK KORTE PARRTESIA UNDEFINED VARIABLE BOLE
                        <td >
                            <h3>
...
<?php echo $__env->make('Rabeya.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\UIUCanteen\resources\views/Rabeya/home.blade.php ENDPATH**/ ?>