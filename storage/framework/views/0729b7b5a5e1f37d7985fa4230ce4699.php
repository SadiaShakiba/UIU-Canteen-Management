          ...
          <div class="row justify-content-center">
              ...
              <div class="col-md-10 mb-5 text-center">
                  <ul class="product-category">
                      ...
                      <li><a href="/khansbrk1" class="active">BREAKFAST</a></li>
                      <li><a href="/khanslunch1">LUNCH</a></li>
                      <li><a href="/khansdrinks1">DRINKS</a></li>
          ...
          <section>
            ...
            <div class="containerpage">
                ...
                <div class="row">
                    ...
                    <?php if($products->canteen_name == 'Khan\'s' && $products->category == 'Breakfast'): ?>
                            ...
                            <div class="text py-3 pb-4 px-3 text-center">
                                ...
                                <div class="bottom-area d-flex px-3">
                                    <div class="m-auto d-flex">
                                        <a href="#" class="add-to-cart d-flex justify-content-center align-items-center text-center" data-toggle="modal" data-target=".bd-example-modal-sm">
                                            <span><i class="ion-ios-menu"></i></span>
                                        </a>
                                        <a href="<?php echo e(route('add_to_cart', $products->product_id)); ?>" class="buy-now d-flex justify-content-center align-items-center mx-1" data-toggle="modal" data-target=".bd-example-modal-sm">
                                            <span><i class="ion-ios-cart"></i></span>
                                        </a>
                                        <a href="<?php echo e(route('add_to_wishlist', $products->product_id)); ?>" class="heart d-flex justify-content-center align-items-center " data-toggle="modal" data-target=".bd-example-modal-sm">
...
<?php echo $__env->make('Rabeya.layouts.main1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\UIUCanteenSadia\resources\views/Rabeya/khansbrk1.blade.php ENDPATH**/ ?>