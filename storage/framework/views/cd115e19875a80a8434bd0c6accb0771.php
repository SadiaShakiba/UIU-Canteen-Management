            ...
            <div class="cart-list"  style="overflow: auto; height:400px; width: 500px; float:left ">
                    ...
                    <tbody >
                        <?php $__currentLoopData = $notice; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="text-center">
                                <td >
                                    <h3>
                                         <?php echo e($notice->notice_head); ?>

                                    </h3>
                                     <div>
                                       <p>
                                        <?php echo e($notice->notice); ?>

                                    </p>
                                     </div>
                                     <h6 style="text-align: right; font-size:10px; color:rgb(169, 169, 169)"> <?php echo e($notice->notice_date); ?></h6>
              ...
              <div class="cart-list"  style="overflow: auto; height:400px; width: 500px; float:right">
                <table class="table ftco-animate" >
                    ...
                    <tbody >
                        <?php $__currentLoopData = $offer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $offer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="text-center">
                                <td >
                                    <h3>
                                         <?php echo e($offer->offer_head); ?>

                                    </h3>
                                     <div>
                                       <p>
                                        <?php echo e($offer->offer); ?>

                                    </p>
                                     </div>
                                     <h6 style="text-align: right; font-size:10px; color:rgb(169, 169, 169)"> <?php echo e($offer->offer_date); ?></h6>
...
<?php echo $__env->make('Rabeya.layouts.main1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\UIUCanteenSadia\resources\views/Rabeya/index.blade.php ENDPATH**/ ?>