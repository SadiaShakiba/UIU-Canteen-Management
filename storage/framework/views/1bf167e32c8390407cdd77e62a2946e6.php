          ...
          <div class="row justify-content-center">
              ...
              <div class="col-md-10 mb-5 text-center">
                  <ul class="product-category">
                      ...
                      <li><a href="/olympiabrk" class="active">BREAKFAST</a></li>
          ...
          <section>
            ...
            <div class="containerpage">
             ...
             <div class="row">
                ...
                <?php if($products->canteen_name == 'Olympia' && $products->category == 'Breakfast'): ?>
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="<?php echo e(route('product_details' , $products->product_id)); ?>" class="img-prod">
                            <img class="img-fluid" src="images/<?php echo e($products->product_image); ?>" width="350px" height="150px" alt="">
...
<?php echo $__env->make('Rabeya.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\UIUCanteen\resources\views/Rabeya/olympiabrk.blade.php ENDPATH**/ ?>