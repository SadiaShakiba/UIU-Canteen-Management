...
<div class="row">
    ...
    <form action="<?php echo e(url('/')); ?>/post_offer" method="post" enctype="multipart/form-data">
        ...
        <input type="text" name="offer_head" id="offer_head"><br>
        <br>

        <textarea name="offer" id="offer" cols="145" rows="10"></textarea><br>
...
<?php echo $__env->make('AdminPanel.layouts.admin_nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\UIUCanteen\resources\views/AdminPanel/offer.blade.php ENDPATH**/ ?>