...
<div class="row">
    ...
    <form action="<?php echo e(url('/')); ?>/post_notice" method="post"  enctype="multipart/form-data">
        ...
        <input type="text" name="notice_head" id="notice_head"><br>
        <br>

        <textarea name="notice" id="notice" cols="145" rows="10"></textarea><br>
...
<?php echo $__env->make('AdminPanel.layouts.admin_nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\UIUCanteen\resources\views/AdminPanel/notice.blade.php ENDPATH**/ ?>